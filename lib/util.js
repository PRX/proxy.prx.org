...
const prxSessionKey = process.env.PRX_SESSION_KEY || '_prx_session_staging';
...
const ROBOT_REGEX = /google|baiduspider|twitterbot|facebookexternalhit|rogerbot|linkedinbot|embedly|quora link preview|showyoubot|outbrain|pinterest|slackbot/i;
...
exports.isCrawler = (userAgent) => {
  return (userAgent || '').match(ROBOT_REGEX);
};
